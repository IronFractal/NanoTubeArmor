package com.Pyro.NanoTubeArmor.Block.Pedestal;

import javax.annotation.Nullable;

import com.Pyro.NanoTubeArmor.ModGuiHandler;
import com.Pyro.NanoTubeArmor.NanoTubeArmor;
import com.Pyro.NanoTubeArmor.Block.BlockBase;
import com.Pyro.NanoTubeArmor.Block.BlockTileEntity;
...
public class BlockPedestal extends BlockTileEntity<TileEntityPedestal>{
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if(!world.isRemote) {
			...
			//player.sendMessage(new TextComponentString(heldItem.toString()));
			...
			if(player.isSneaking()) {
				...
				player.openGui(NanoTubeArmor.instance, ModGuiHandler.PEDESTAL, world, pos.getX(), pos.getY(), pos.getZ());
